...
const Dashboard = ({ formData, onLogout, updateFormData }) => {
  ...
  if (showPortfolio) {
    return <PortfolioPDF formData={editedData} onBack={() => setShowPortfolio(false)} />;
  }
    ...
    <div className="dashboard-container">
      <div className="dashboard-header">
        ...
        <div className="dashboard-actions">
          ...
          <button onClick={() => setShowPortfolio(true)} className="view-portfolio-btn">
        ...
        <div className="dashboard-grid">
          ...
          <div className="dashboard-card">
            ...
            <div className="action-buttons">
              <button onClick={() => setShowPortfolio(true)} className="action-btn view-btn">
